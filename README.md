...
| `/who/[id]` | 39 statically generated character pages — full-bleed portraits dissolving into the void (shader-side veil, no hard edges), epithets, relationships, arms, divine parentage, and guided-depth fates; Arjuna, Bhishma and Draupadi carry **DARK-style journeys**: their lives scroll parva by parva while the background painting crossfades per chapter, with a Devanagari chapter rail |
